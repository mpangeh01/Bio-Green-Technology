        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Model Management</div>
                    <div class="ps-3">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger border-0 alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="mb-0">This Model Already Exists </h6>
                            </div>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <form action="{{ route('update.model', ['id' => $carModel]) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="location"
                                                    placeholder="Mazda" value="{{ $carModel->name }}" required>
                                            </div>
