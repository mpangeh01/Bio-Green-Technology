                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add New Route</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                ...
                @if ($errors->any())
                    <div class="alert alert-danger border-0 alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h6 class="mb-0">This route already exists</h6>
                            </div>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <form action="{{ route('store.fare') }}" method="POST"
                                            enctype="multipart/form-data">

                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label">From (Origin)</label>
                                                <select name="from" class="form-select form-select-sm mb-3"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="to" class="form-select form-select-sm mb-3"
                                                    aria-label=".form-select-sm example" id="destination">
                                                    @foreach ($locations as $location)
                                                        <option value="{{ $location->id }}">{{ $location->name }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="mb-3">
                                                <button type="submit" class="btn btn-outline-primary"
                                                    style="width: 100%">Add Fare</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
